...
router.get('/get-all', (0, auth_1.default)(user_constant_1.USER_ROLE.admin), review_controller_1.reviewController.getAllReviewsFromDb);
router.patch('/update-review/:reviewId/product/:productId', (0, validateRequest_1.default)(review_validation_1.ReviewValidationSchema.updateReviewValidation), (0, auth_1.default)(user_constant_1.USER_ROLE.customer), review_controller_1.reviewController.updateReviewIntoDb);
...
router.get('/get-review-by-id/:reviewId', review_controller_1.reviewController.getSingleReviewById);
